...
Proof.
  repeat intro.
  destruct (PLT.hom_directed _ _ _ f g nil).
  - hnf; auto.
...
Proof.
  ...
  - destruct a as [[a x] b]. 
    ...
    + subst b.
      ...
      * hnf; auto.
      * red; intros. apply nil_elem in H1. elim H1.
...
Proof.
  ...
  - destruct a; simpl.
    ...
    + apply eff_complete.
    + destruct c0. apply single_axiom. auto.
  - destruct a.
    apply PLT.compose_hom_rel.
      ...
      * simpl. apply single_axiom.
        ...
        { destruct (PLT.hom_directed _ _ _ g tt (Some x::Some c0::nil)).
          ...
          - destruct H2.  
            ...
            destruct x0.
            * hnf in H4. hnf in H5. subst c; auto.
            * elim H4.
        } 
        subst c0. auto.
  - destruct a.
