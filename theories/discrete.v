...
Section disc_cases.
  ...
  Next Obligation.
    ...
    - red; simpl; intros. apply H in H0.
      ...
      apply erel_image_elem.    
      apply (mk_disc_cases_elem (fintype.fintype_list X) x a a0); auto.
      apply fintype.fintype_complete.
    - destruct H0.    
      apply erel_image_elem in H1.
      exists x0. split; auto.
      apply erel_image_elem.    
      apply (mk_disc_cases_elem (fintype.fintype_list X) x a x0); auto.
      apply fintype.fintype_complete.
  Qed.
  ...
  Proof.
    ...
    - destruct a.
      ...
      + apply PLT.pair_hom_rel. split; auto.
        ...
        destruct c. auto.
      + apply (mk_disc_cases_elem (fintype.fintype_list X)); auto.
        apply fintype.fintype_complete.
  Qed.
